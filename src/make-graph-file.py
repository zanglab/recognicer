...
#    print 'positive count:' + str(postive_tag_counts);
#    print 'positive count:' + str(negative_tag_counts);
#    print 'total tag count is: ' +  str(total_tag_counts) + ' = ' + str(postive_tag_counts) + '+' + str(negative_tag_counts) ;
    infile.close();						       
    return taglist;
    
    
    
def Generate_windows_and_count_tags(taglist, chrom, window_size, file):
    """
...
def main(argv):
    ...
    bed_vals = Generate_windows_and_count_tags(tag_list, opt.chrom,
